    ...
    <div style={{ minHeight: '100vh', background: '#0F172A', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ background: '#1E293B', padding: '10px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '1px solid #334155' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          <div style={{ width: 8, height: 8, borderRadius: '50%', background: joined ? '#22C55E' : '#F59E0B', animation: joined ? 'none' : 'pulse 1.5s infinite' }} />
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, position: 'relative' }}>
        {error ? (
          <div style={{ textAlign: 'center', color: '#fff' }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 600, marginBottom: 8 }}>Could not join the video call</p>
          ...
          <div style={{ textAlign: 'center', color: '#fff' }}>
            ...
            <p style={{ fontWeight: 600, fontSize: 15 }}>Joining video consultation…</p>
            ...
            <div ref={remoteVideoRef} style={{
              ...
              {!remoteUser && (
                <div style={{ textAlign: 'center', color: '#64748B' }}>
                  ...
                  <p style={{ fontSize: 14, fontWeight: 600 }}>Waiting for the doctor to join…</p>
                </div>
              )}
            </div>
